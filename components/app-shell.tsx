    ...
    <SidebarProvider>
      <div className="flex h-[100dvh] w-full overflow-hidden bg-background">
        ...
        <SidebarInset className="flex flex-col h-full overflow-hidden bg-slate-50/50">
          <header className="sticky top-0 z-20 flex h-16 shrink-0 items-center justify-between border-b border-slate-200/60 bg-white/80 backdrop-blur-md px-8 shadow-sm">
            <div className="flex items-center gap-4 min-w-0">
              <SidebarTrigger className="-ml-1 opacity-60 hover:opacity-100 transition-opacity" />
              <div className="font-bold text-xs tracking-[0.1em] text-slate-500 truncate uppercase">
                {title}
              </div>
            </div>
