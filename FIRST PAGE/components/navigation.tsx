      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        >
          <div className="relative w-6 h-6">
            ...
            />
            <span
              className={`absolute left-0 top-3 block h-0.5 w-6 bg-current transition-all duration-300 ease-out ${
        ...
        <div className="glass mt-2 mx-4 rounded-lg p-4">
          {navLinks.map((link, index) => (
            <a
              ...
              href={link.href}
              onClick={(e) => handleNavClick(e, link.href)}
              className={`block py-3 text-muted-foreground hover:text-foreground transition-all duration-300 border-b border-border/30 last:border-0 transform ${
                isMobileMenuOpen 
          ...
          <div className="flex gap-2 mt-4 pt-2">
            <Button variant="ghost" className="flex-1 text-foreground">
              შესვლა
            </Button>
